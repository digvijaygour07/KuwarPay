...
app.post('/payment-confirmation', async (req, res) => {
  try {
    ...
    if (paymentResponse.status === 'success') {
      ...
      const deepLinkUrl = 'upi://phonepe/pay?pa=9822242222@axl&pn=mahendra%20gour&am=1&tn=Half%20Sleeve%20Casual%20Shirt%20for%20Men&cu=INR';
...
app.post('/orders', async (req, res) => {
  try {
    ...
    const deepLinkUrl = `upi://pay?pa=${sellerPhonePeId}&pn=${encodeURIComponent(sellerName.toLowerCase())}&am=${paymentAmount}&tn=${paymentDescription}&cu=INR`;
